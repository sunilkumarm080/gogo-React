            ...
            >
              <Nav vertical className="list-unstyled">
                ...
                >
                  ...
                  >
                    <i className="iconsmind-Paypal" />{" "}
                    <IntlMessages id="menu.payroll" />
                  </NavLink>
                </NavItem>
                ...
                >
                  ...
                  >
                    <i className="iconsmind-Calendar-2" />{" "}
                    <IntlMessages id="menu.leave" />
                  </NavLink>
                </NavItem>
                ...
                >
                  <NavLink
                    ...
                    onClick={e => this.openSubMenu(e, "gogo")}
                  >
                    <i className="iconsmind-Search-People" />{" "}
                    <IntlMessages id="menu.emp" />
                  </NavLink>
                </NavItem>
                ...
                >
                  <NavLink
                    ...
                    onClick={e => this.openSubMenu(e, "gogo")}
                  >
                    <i className="iconsmind-Folder-WithDocument" />{" "}
                ...
                >
                  <NavLink
                    ...
                    onClick={e => this.openSubMenu(e, "gogo")}
                  >
                    <i className="iconsmind-Folder-Add" />{" "}
                    <IntlMessages id="menu.yf" />
                  </NavLink>
                </NavItem>
                ...
                >
                  <NavLink
                    ...
                    onClick={e => this.openSubMenu(e, "gogo")}
                  >
                    <i className="iconsmind-Data-Settings" />{" "}
